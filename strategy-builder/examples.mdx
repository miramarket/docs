...
Several of these patterns are also available as one-click [strategy templates](/strategy-builder/templates) in the builder, so you do not have to add every node by hand.
